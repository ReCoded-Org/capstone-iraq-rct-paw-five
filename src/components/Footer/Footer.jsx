            ...
            <Container>
                <Row>
                    <Col className="text-center pt-5" lg={4} md={6}>
                        ...
                        <Container fluid>
                        <FontAwesomeIcon icon={faFacebookF} className='text-danger ml-2 mr-2'/>
                        <FontAwesomeIcon icon={faTwitter} className='text-danger ml-2 mr-2'/>
                        <FontAwesomeIcon icon={faInstagram} className='text-danger ml-2 mr-2'/>
                        <FontAwesomeIcon icon={faYoutube} className='text-danger ml-2 mr-2'/>
                        </Container>
                    </Col>
                    ...
                    <Col className="m-auto"lg={4} md={6}>
                        ...
                        <Container fluid className="text-center">
                            ...
                            <FontAwesomeIcon icon={faMapMarkerAlt} className=' text-danger ml-2 mr-2' />
                                {t('footer.cites')}{' '}
                            </li>
                            <li className='m-3 list-unstyled  text-dark'>
                            <FontAwesomeIcon icon={faMobile} className=' text-danger ml-2 mr-2'/>
                                
                                {t('footer.phoneNo')}
                            </li>
                            <li className='m-3 list-unstyled text-dark'>
                            <FontAwesomeIcon icon={faEnvelope} className='text-danger  ml-2 mr-2' />
                                {t('footer.email')}
                            </li>
                            <li className='m-3 list-unstyled text-dark'>
                            <FontAwesomeIcon icon={faPowerOff} className='text-danger ml-2 mr-2'  />
